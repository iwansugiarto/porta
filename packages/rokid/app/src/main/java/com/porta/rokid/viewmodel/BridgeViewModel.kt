package com.porta.rokid.viewmodel
...
import com.porta.rokid.data.PortaClient
import com.porta.rokid.service.voice.TextToSpeechService
import com.porta.rokid.service.voice.VoiceInputService
import com.porta.rokid.shared.protocol.*
import com.porta.rokid.shared.protocol.stepsToMessages
    ...
    private fun handleIncomingMessage(message: PortaMessage) {
        when (message) {
            ...
            is PortaMessage.Status -> {
                ...
                // Read latest response when agent finishes
                if (!message.running && _ttsEnabled.value) {
                    val lastText = _latestResponse.value
                    if (lastText.isNotBlank()) {
                        tts.speak(lastText.take(500)) // Cap TTS at 500 chars
                    }
                }
            }
